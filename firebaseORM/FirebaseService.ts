...
class FirebaseAdminService {
  ...
  private rtdb: admin.database.Database = rtdb;
   ...
   */
  async searchWheres(
    wheres: { field: string; operator: Operator; value: any }[],
  ...
  setRelation(
    ...
    options: {
      ...
      foreignKey: string;
      localKey: string;
      onDeleteNull?: boolean; // New option
    }
  ): void {
